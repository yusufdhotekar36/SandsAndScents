      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-300">
            ...
            <li><Link to="/data-deletion-policy" className="hover:text-orange-400">Data Deletion Policy</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="space-y-3 text-gray-300">
            ...
            <p className="flex items-center space-x-2">
              ...
              <a href="https://chat.whatsapp.com/JbmJWWnLTpgL7ejtBoy4Qs?mode=r_c" target="_blank" rel="noopener noreferrer" className="hover:text-orange-400 underline">WhatsApp Community</a>
            </p>
          </div>
        </div>
